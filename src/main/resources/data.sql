...
INSERT INTO USER_ADDITIONAL_DATA VALUES (1002,'1994-01-17','Dada','MEN','Lubartów', true,'Kamiński','111002666', 'https://randomuser.me/api/portraits/men/75.jpg');
INSERT INTO USER_ADDITIONAL_DATA VALUES (1003,'1979-07-13','Jessica','OTHER','Warszawa', true,'Łukasiewicz','111003666', 'https://randomuser.me/api/portraits/women/47.jpg');
INSERT INTO USER_ADDITIONAL_DATA VALUES (1004,'1996-12-24','Paulina','WOMEN','Krakow', false,'Lechman','111004666', 'https://randomuser.me/api/portraits/women/28.jpg');
...
INSERT INTO POST_COMMENT VALUES (10001, CURRENT_TIMESTAMP, 'Phasellus elit erat, eleifend vitae condimentum condimentum, ultricies sit amet magna. Cras nec rhoncus elit. Phasellus commodo est lacinia dictum posuere. Nunc sem magna, consectetur vitae sagittis in, facilisis id risus. Donec et hendrerit arcu. Praesent convallis, mauris et vulputate iaculis.', 3, 1000);
INSERT INTO POST_COMMENT VALUES (10002, CURRENT_TIMESTAMP, 'Maecenas dapibus fringilla massa nec mattis.', 2, 1000);
INSERT INTO POST_COMMENT VALUES (20000, CURRENT_TIMESTAMP, 'Aenean sed', 2, 2000);
INSERT INTO POST_COMMENT VALUES (20001, CURRENT_TIMESTAMP, 'Praesent vitae erat imperdiet, lobortis risus finibus, hendrerit lectus. Sed mollis, dui in eleifend semper, metus lorem varius nunc, et interdum felis nulla non erat.', 4, 2000);
INSERT INTO POST_COMMENT VALUES (20002, CURRENT_TIMESTAMP, 'Suspendisse sed lectus convallis massa aliquam posuere.', 1, 4000);
